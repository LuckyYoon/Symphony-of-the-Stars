...
export default function AtmospheresOfDistantWorldsPage() {
  ...
  const data = discoveriesData.discoveries[1];
  ...
  return (
    <Box height="100vh" width="100vw" position="relative" bg="black">
      ...
      <audio
        ref={audioRefDefault}
        src={`${process.env.PUBLIC_URL}/assets/music/atmospheres_of_distant_worls/bass.wav`}
        loop
      />
      ...
      {data.characteristics.slice(0, 3).map((char, index) => (
        ...
        >
          ...
          <audio
            ...
            src={
              index === 0
                ? `${process.env.PUBLIC_URL}/assets/music/atmospheres_of_distant_worls/percussion.wav`
                : index === 1
                ? `${process.env.PUBLIC_URL}/assets/music/atmospheres_of_distant_worls/others.wav`
                : `${process.env.PUBLIC_URL}/assets/music/atmospheres_of_distant_worls/srings.wav`
            }
            loop
          />
        </Box>
