...
export default function AtmospheresOfDistantWorldsPage() {
 ...
 return (
   <Box height="100vh" width="100vw" position="relative" bg="black">
     ...
     <audio
       ref={audioRefDefault}
       src="/assets/music/atmospheres_of_distant_worls/bass.wav"
       loop
     />
     ...
     {data.characteristics.slice(0, 3).map((char, index) => (
       ...
       >
         ...
         <audio
           ...
           src={
             index === 0
               ? "/assets/music/atmospheres_of_distant_worls/percussion.wav"
               : index === 1
               ? "/assets/music/atmospheres_of_distant_worls/others.wav"
               : "/assets/music/atmospheres_of_distant_worls/strings.wav"
