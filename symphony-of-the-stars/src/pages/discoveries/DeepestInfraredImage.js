...
export default function DeepestInfraredImagePage() {
  ...
  const data = discoveriesData.discoveries[2];
  ...
  return (
    <Box height="100vh" width="100vw" position="relative" bg="black">
      ...
      <audio
        ref={audioRefDefault}
        src={`${process.env.PUBLIC_URL}/assets/music/deepest_infrared_image/bass.wav`}
        loop
      />
      ...
      {data.characteristics.slice(0, 3).map((char, index) => (
        ...
        >
          ...
          <audio
            ...
            src={
              index === 0
                ? `${process.env.PUBLIC_URL}/assets/music/deepest_infrared_image/percussion.wav`
                : index === 1
                ? `${process.env.PUBLIC_URL}/assets/music/deepest_infrared_image/strings.wav`
                : `${process.env.PUBLIC_URL}/assets/music/deepest_infrared_image/vocals.wav`
            }
            loop
          />
        </Box>
