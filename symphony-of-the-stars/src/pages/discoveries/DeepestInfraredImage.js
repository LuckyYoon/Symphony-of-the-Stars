...
export default function DeepestInfraredImagePage() {
 ...
 return (
   <Box height="100vh" width="100vw" position="relative" bg="black">
     ...
     <audio
       ref={audioRefDefault}
       src="/assets/music/deepest_infrared_image/bass.wav"
       loop
     />
     ...
     {data.characteristics.slice(0, 3).map((char, index) => (
       ...
       >
         ...
         <audio
           ...
           src={
             index === 0
               ? "/assets/music/deepest_infrared_image/percussion.wav"
               : index === 1
               ? "/assets/music/deepest_infrared_image/strings.wav"
               : "/assets/music/deepest_infrared_image/vocals.wav"
           }
           loop
         />
       </Box>
