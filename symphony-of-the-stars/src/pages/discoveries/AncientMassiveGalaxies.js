...
export default function AncientMassiveGalaxiesPage() {
 ...
 return (
   <Box height="100vh" width="100vw" position="relative" bg="black">
     ...
     <audio
       ref={audioRefDefault}
       src="/assets/music/ancient_massive_galaxies/bass.wav"
       loop
     />
     ...
     {data.characteristics.slice(0, 3).map((char, index) => (
       ...
       >
         ...
         <audio
           ...
           src={
             index === 0
               ? "/assets/music/ancient_massive_galaxies/percussion1.wav"
               : index === 1
               ? "/assets/music/ancient_massive_galaxies/percussion2.wav"
               : "/assets/music/ancient_massive_galaxies/others.wav"
           }
           loop
         />
       </Box>
