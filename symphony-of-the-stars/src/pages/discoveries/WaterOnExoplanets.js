...
export default function WaterOnExoplanetsPage() {
 ...
 return (
   <Box height="100vh" width="100vw" position="relative" bg="black">
     ...
     <audio
       ref={audioRefDefault}
       src="/assets/music/water_on_exoplanets/bass.wav"
       loop
     />
     ...
     {data.characteristics.slice(0, 3).map((char, index) => (
       ...
       >
         ...
         <audio
           ...
           src={
             index === 0
               ? "/assets/music/water_on_exoplanets/strings.wav"
               : index === 1
               ? "/assets/music/water_on_exoplanets/fx.wav"
               : "/assets/music/water_on_exoplanets/others.wav"
           }
           loop
         />
       </Box>
