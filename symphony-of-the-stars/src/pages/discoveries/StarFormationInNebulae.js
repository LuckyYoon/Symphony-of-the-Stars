...
export default function StarFormationInNebulaePage() {
  ...
  return (
    <Box height="100vh" width="100vw" position="relative" bg="black">
      ...
      <audio
        ref={audioRefDefault}
        src={`${process.env.PUBLIC_URL}/assets/music/star_formation_in_nebulae/bass.wav`}
        loop
      />
      ...
      {data.characteristics.slice(0, 3).map((char, index) => (
        ...
        >
          ...
          <audio
            ...
            src={
              index === 0
                ? `${process.env.PUBLIC_URL}/assets/music/star_formation_in_nebulae/drums.wav`
                : index === 1
                ? `${process.env.PUBLIC_URL}/assets/music/star_formation_in_nebulae/fx.wav`
                : `${process.env.PUBLIC_URL}/assets/music/star_formation_in_nebulae/synth.wav`
            }
            loop
          />
        </Box>
