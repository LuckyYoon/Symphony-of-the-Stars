...
export default function StarFormationInNebulaePage() {
 ...
 return (
   <Box height="100vh" width="100vw" position="relative" bg="black">
     ...
     <audio
       ref={audioRefDefault}
       src="/assets/music/star_formation_in_nebulae/bass.wav"
       loop
     />
     ...
     {data.characteristics.slice(0, 3).map((char, index) => (
       ...
       >
         ...
         <audio
           ...
           src={
             index === 0
               ? "/assets/music/star_formation_in_nebulae/drums.wav"
               : index === 1
               ? "/assets/music/star_formation_in_nebulae/fx.wav"
               : "/assets/music/star_formation_in_nebulae/synth.wav"
           }
           loop
         />
       </Box>
